<map><node BACKGROUND_COLOR="" COLOR="#000000" FOLDED="false" STYLE="fork" TEXT="ocean"><font BOLD="True" NAME="courier" SIZE="14" /><richcontent TYPE="NOTE"><html>
  ...
  <body>
    <dl>
        <dt><b>Description</b></dt><dd>Extra properties of conservation in the ocean component</dd><dt><b>ID</b></dt><dd>cmip6.ocean.key_properties.conservation.details</dd>
    </dl>
  </body>
  ...
  <body>
    <dl>
        <dt><b>Description</b></dt><dd>Properties conserved in the ocean by the numerical schemes</dd><dt><b>ID</b></dt><dd>cmip6.ocean.key_properties.conservation.details.scheme</dd><dt><b>Type</b></dt><dd>enum</dd><dt><b>Cardinality</b></dt><dd>1.N</dd>
    </dl>
  </body>
</html></richcontent><richcontent TYPE="NOTE"><html>
  <head />
